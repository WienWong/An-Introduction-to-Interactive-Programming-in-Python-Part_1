...
# http://www.codeskulptor.org/#user39_4QBbwORHtE_12.py
...
def draw(canvas):
    ...
    if (ball_pos[0] <= (BALL_RADIUS + PAD_WIDTH)):
        if (ball_pos[1] < (paddle1_pos - HALF_PAD_HEIGHT)) or (ball_pos[1] > (paddle1_pos + HALF_PAD_HEIGHT)):
            ...
            ball_vel[0] = - ball_vel[0] * 1.2 	# flip horizontal component of velocity!
    ...
    canvas.draw_polygon([[0, paddle1_pos - HALF_PAD_HEIGHT], [PAD_WIDTH/2, paddle1_pos - HALF_PAD_HEIGHT], \
                         [PAD_WIDTH / 2, paddle1_pos + HALF_PAD_HEIGHT], [0, paddle1_pos + HALF_PAD_HEIGHT]], 10, 'Red')
    canvas.draw_polygon([[WIDTH, paddle2_pos - HALF_PAD_HEIGHT], [WIDTH, paddle2_pos + HALF_PAD_HEIGHT], \
                         [WIDTH - PAD_WIDTH / 2, paddle2_pos + HALF_PAD_HEIGHT], [WIDTH - PAD_WIDTH / 2, paddle2_pos - HALF_PAD_HEIGHT]], 10, 'Red')
